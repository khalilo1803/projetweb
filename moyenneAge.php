...
<body>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <div id="afficher" >
         ...
         <h1 style="text-align: center;color: #2c3e50">La Moyenne Des Ages des Clients :</h1>
          <h1 style="text-align: center;color: #c0392b ;font-size: 100px"><?php echo $moyenneAge/$nbclients;?> ans</h1>
