                ...
                <div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
                    ...
                    <a class="icons" href="mailto:support@colorlib.com">
                        ...
                        <form action="connexion.php" method="POST">
                            <input type="text" id="log" name="log" style=" width: 150px;" >
                            <input type="text" id="mdp" name="mdp" style=" width: 150px; ">
                            <input type="submit" name="abbb" value="ENTRER">
                        </form>
                ...
                <form class="form-area contact-form text-right"   method="post" action="ajoutsav.php"  >
                    <div class="row">
                        <div class="col-lg-6 form-group">
                            ...
                            <input  name="nom" id="nom" class="common-input mb-20 form-control" hidden value="<?php echo $_SESSION['r']; ?> " >
